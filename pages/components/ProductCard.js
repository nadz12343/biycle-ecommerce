...
export default function ProductCard({width, height, id, name, category, type, brand, price, imgpath, rating, bestseller}){
    ...
    return (
        <div className= {className_} style={{backgroundColor: "#FFFFFF"}}>
            ...
            <div className="flex items-center justify-center pt-24">
                <div className="w-full h-full ml-[30%] md:ml-64" style={{backgroundImage: `url('./${imgpath}/1.jpeg')`, backgroundSize:"contain", backgroundRepeat: "no-repeat"}}></div>
            </div>


            <div className="mt-32 rounded-md h-fit" style={{backgroundImage: "url(./assets/bg/bg-card.png)", backgroundSize: "cover", backdropFilter: 'blur(5px)'}}>
